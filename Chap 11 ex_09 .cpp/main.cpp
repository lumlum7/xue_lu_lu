...
int main()
{
   Package package1( "Li Hua", "Xue Lulu", "QingDao", "ShanDong", 266510,
      "Mary", "Li", "New York", "NY", 22221, 9.5, 0.5 );
   TwoDayPackage package2( "Lisa", "Song", "Heze", "MA",
      33333, "Bob George", "21 Pine Rd", "Cambridge", "MA", 44424,
      10.5, 0.65, 2.0 );
   OvernightPackage package3( "Ed Lewis", "2 Oak St", "Boston", "MA",
      11111, "Liu", "Lisa", "QingDao", "COO", 666666,
      12.25, 0.7, 0.25 );
